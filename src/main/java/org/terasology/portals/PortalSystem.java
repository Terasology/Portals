...
/**
 * System that handles interactions with portals TODO: Add a game hook for world creation that at the end adds a portal
 * by the player start location (only runs once per world)
 *
